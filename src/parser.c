...
enum ts_symbol_identifiers {
  ...
  anon_sym_LBRACK = 10,
  anon_sym_RBRACK = 11,
  anon_sym_broadcast = 12,
  anon_sym_costume = 13,
  anon_sym_sound = 14,
  anon_sym_block = 15,
  anon_sym_LPAREN = 16,
  anon_sym_RPAREN = 17,
  aux_sym_seg_field_token1 = 18,
  anon_sym_LBRACE = 19,
  anon_sym_RBRACE = 20,
  ...
  sym_seg_mouth = 44,
  sym__stack_block = 45,
  aux_sym_words_repeat1 = 46,
  aux_sym_comment_repeat1 = 47,
  aux_sym_decls_repeat1 = 48,
  aux_sym_decl_list_repeat1 = 49,
  aux_sym_segments_repeat1 = 50,
  aux_sym_seg_field_repeat1 = 51,
  aux_sym_seg_mouth_repeat1 = 52,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_costume] = "costume",
  [anon_sym_sound] = "sound",
  [anon_sym_block] = "block",
  [anon_sym_LPAREN] = "(",
  [anon_sym_RPAREN] = ")",
  [aux_sym_seg_field_token1] = "seg_field_token1",
  [anon_sym_LBRACE] = "{",
  [anon_sym_RBRACE] = "}",
  ...
  [sym__stop] = "_stop",
  [sym_file_def] = "file_def",
  [sym_words] = "words",
  [sym_comment] = "comment",
  [sym_decls] = "decls",
  [sym_decl] = "decl",
  [sym_decl_set] = "decl_set",
  [sym_decl_var] = "decl_var",
  [sym_decl_list] = "decl_list",
  [sym_decl_broadcast] = "decl_broadcast",
  [sym_decl_costume] = "decl_costume",
  [sym_decl_sound] = "decl_sound",
  [sym_decl_block] = "decl_block",
  [sym_segments] = "segments",
  [sym_segment] = "segment",
  [sym_literal] = "literal",
  [sym_seg_reporter] = "seg_reporter",
  [sym_seg_field] = "seg_field",
  [sym_seg_mouth] = "seg_mouth",
  [sym__stack_block] = "_stack_block",
  [aux_sym_words_repeat1] = "words_repeat1",
  [aux_sym_comment_repeat1] = "comment_repeat1",
  [aux_sym_decls_repeat1] = "decls_repeat1",
  [aux_sym_decl_list_repeat1] = "decl_list_repeat1",
  [aux_sym_segments_repeat1] = "segments_repeat1",
  [aux_sym_seg_field_repeat1] = "seg_field_repeat1",
  [aux_sym_seg_mouth_repeat1] = "seg_mouth_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [anon_sym_costume] = anon_sym_costume,
  [anon_sym_sound] = anon_sym_sound,
  [anon_sym_block] = anon_sym_block,
  [anon_sym_LPAREN] = anon_sym_LPAREN,
  [anon_sym_RPAREN] = anon_sym_RPAREN,
  [aux_sym_seg_field_token1] = aux_sym_seg_field_token1,
  [anon_sym_LBRACE] = anon_sym_LBRACE,
  [anon_sym_RBRACE] = anon_sym_RBRACE,
  [sym_string_literal] = sym_string_literal,
  [sym_number_literal] = sym_number_literal,
  [sym_sprite] = sym_sprite,
  [sym_stage] = sym_stage,
  [sym_source_file] = sym_source_file,
  [sym__stop] = sym__stop,
  [sym_file_def] = sym_file_def,
  [sym_words] = sym_words,
  [sym_comment] = sym_comment,
  [sym_decls] = sym_decls,
  [sym_decl] = sym_decl,
  [sym_decl_set] = sym_decl_set,
  [sym_decl_var] = sym_decl_var,
  [sym_decl_list] = sym_decl_list,
  [sym_decl_broadcast] = sym_decl_broadcast,
  [sym_decl_costume] = sym_decl_costume,
  [sym_decl_sound] = sym_decl_sound,
  [sym_decl_block] = sym_decl_block,
  [sym_segments] = sym_segments,
  [sym_segment] = sym_segment,
  [sym_literal] = sym_literal,
  [sym_seg_reporter] = sym_seg_reporter,
  [sym_seg_field] = sym_seg_field,
  [sym_seg_mouth] = sym_seg_mouth,
  [sym__stack_block] = sym__stack_block,
  [aux_sym_words_repeat1] = aux_sym_words_repeat1,
  [aux_sym_comment_repeat1] = aux_sym_comment_repeat1,
  [aux_sym_decls_repeat1] = aux_sym_decls_repeat1,
  [aux_sym_decl_list_repeat1] = aux_sym_decl_list_repeat1,
  [aux_sym_segments_repeat1] = aux_sym_segments_repeat1,
  [aux_sym_seg_field_repeat1] = aux_sym_seg_field_repeat1,
  [aux_sym_seg_mouth_repeat1] = aux_sym_seg_mouth_repeat1,
};
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_seg_field_repeat1] = {
    .visible = false,
    .named = false,
  },
  [aux_sym_seg_mouth_repeat1] = {
    .visible = false,
    .named = false,
  },
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_word_character_set_1, 668, lookahead)) ADVANCE(27);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(9);
    ...
    case 19:
      ...
      END_STATE();
    case 20:
      ACCEPT_TOKEN(aux_sym_seg_field_token1);
      END_STATE();
    case 21:
      ACCEPT_TOKEN(aux_sym_seg_field_token1);
      if (lookahead == '#') ADVANCE(12);
    ...
    case 27:
      ...
      if (set_contains(sym_word_character_set_2, 776, lookahead)) ADVANCE(27);
      END_STATE();
    default:
      return false;
  }
...
static bool ts_lex_keywords(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 40:
      ...
      END_STATE();
    case 41:
      ACCEPT_TOKEN(sym_sprite);
      END_STATE();
    case 42:
      if (lookahead == 's') ADVANCE(44);
      END_STATE();
    case 43:
      ACCEPT_TOKEN(anon_sym_costume);
      END_STATE();
    case 44:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [sym_sprite] = ACTIONS(1),
    [sym_stage] = ACTIONS(1),
  },
  [1] = {
    [sym_source_file] = STATE(81),
    [sym_file_def] = STATE(66),
    [sym_comment] = STATE(1),
    [anon_sym_POUND] = ACTIONS(3),
    [sym_sprite] = ACTIONS(5),
    [sym_stage] = ACTIONS(5),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [7] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, 0, 0),
  ...
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_segments, 1, 0, 0),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_segments_repeat1, 2, 0, 0), SHIFT_REPEAT(12),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_segments_repeat1, 2, 0, 0),
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_segments_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [47] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_segments_repeat1, 2, 0, 0), SHIFT_REPEAT(9),
  [50] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_segments_repeat1, 2, 0, 0), SHIFT_REPEAT(61),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_segments_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 1, 0, 0),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_segment, 1, 0, 0),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_segments_repeat1, 1, 0, 0),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_seg_field, 2, 0, 0),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_seg_field, 3, 0, 0),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_seg_reporter, 3, 0, 0),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_seg_mouth, 3, 0, 0),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_seg_mouth, 4, 0, 0),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_decl_list_repeat1, 2, 0, 0),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_decl_list_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [77] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [79] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [81] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_words, 2, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_words, 1, 0, 0),
  [87] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_words_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_words_repeat1, 2, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = false}}, SHIFT(30),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_seg_field_repeat1, 2, 0, 0),
  [96] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_seg_field_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  [99] = {.entry = {.count = 1, .reusable = false}}, SHIFT(83),
  [101] = {.entry = {.count = 1, .reusable = false}}, SHIFT(62),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_decls_repeat1, 2, 0, 0),
  [105] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_decls_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2, 0, 0),
  [110] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_words_repeat1, 1, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = false}}, SHIFT(84),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decls, 2, 0, 0),
  [119] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_decl_list_repeat1, 1, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decls, 1, 0, 0),
  ...
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_def, 1, 0, 0),
  [133] = {.entry = {.count = 1, .reusable = false}}, SHIFT(14),
  [135] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stop, 1, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_broadcast, 3, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_costume, 3, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_sound, 3, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_seg_field_repeat1, 1, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_block, 3, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl, 1, 0, 0),
  [153] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [155] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_seg_mouth_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_set, 5, 0, 2),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_var, 5, 0, 2),
  [162] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [164] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 1, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_list, 6, 0, 0),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_list, 7, 0, 3),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_def, 2, 0, 1),
  [172] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_seg_mouth_repeat1, 2, 0, 0),
  ...
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stack_block, 2, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, 0, 0),
  ...
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 0),
...
TS_PUBLIC const TSLanguage *tree_sitter_itch(void) {
